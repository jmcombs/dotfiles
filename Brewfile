...
cask "alfred"                       # Productivity app and Spotlight replacement
cask "bartender"                    # Menu bar item organizer and manager
cask "istat-menus"                  # Advanced system monitoring in menu bar
